...
int main(int argc, char const *argv[])
{
    ...
    std::cout << "use case 1 -- convensional usage test (no sync): retval = {" << retval.value
              << ", {" << retval.info[0] << ", " << retval.info[1] << "}}" << std::endl;
    ...
    std::cout << "use case 2 -- synchronous usage test with default signal "
                 "SIGUSR1: retval = {"
              << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
              << std::endl;
    if (retval.value == NO_ERROR)
    {
        tc_passed[tc_num] = true;
    ...
    for (int i = SIGHUP; i <= SIGSYS; i++)
    {
        ...
        std::cout << "use case 3 -- synchronous usage test with user specified "
                     "signal: retval = {"
                  << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
                  << std::endl;
        if (retval.value == NO_ERROR)
    ...
    std::cout << "use case 3 -- invalid signal: retval = {" << retval.value << ", " << retval.info
              << "}" << std::endl;
    if (retval.value != NO_ERROR)
    {
        tc_passed[tc_num] = true;
    ...
    std::cout << "use case 4 -- handling close exception >> synchronous usage "
                 "test with default signal SIGUSR1: retval = {"
              << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
              << std::endl;
    if (retval.value == NO_ERROR)
    {
    ...
    for (int i = SIGHUP; i <= SIGSYS; i++)
    {
        ...
        std::cout << "use case 5 -- handling close exception >> synchronous "
                     "usage test with user specified signal: retval = {"
                  << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
                  << std::endl;
        if (retval.value == NO_ERROR)
        {
    ...
    std::cout << "use case 6 -- open and close with imvalid pid with default "
                 "signal SIGUSR1: retval = {"
              << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
              << std::endl;
    if (retval.value == NO_ERROR)
    {
    ...
    std::cout << "use case 7 -- open-startpreview-stoppreview-close with "
                 "invalid pid with default signal SIGUSR1: retval = {"
              << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
              << std::endl;
    if (retval.value == NO_ERROR)
    {
    ...
    std::cout << "use case 8 -- open with invalid "
                 "pid-startpreview-stoppreview-close with default signal "
                 "SIGUSR1: retval = {"
              << retval.value << ", {" << retval.info[0] << ", " << retval.info[1] << "}}"
              << std::endl;
    if (retval.value == NO_ERROR)
