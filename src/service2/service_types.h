...
#define SRV_LOG_ERROR(module, args...) PmLogMsg(getCameraLunaPmLogContext(), Error, module, 0, ##args)
...
typedef struct _camera_properties
{
    int n_zoom;
    int n_gridzoom_x;
    int n_gridzoom_y;
    ...
    int b_yuvmode;
    int n_illumination;
    int b_backlightcompensation;
    int n_mic_maxgain;
    int n_mic_mingain;
    int n_micgain;
    int b_micmute;

    _camera_properties() : n_zoom(CONST_VARIABLE_INITIALIZE),
                           n_gridzoom_x(CONST_VARIABLE_INITIALIZE),
                           n_gridzoom_y(CONST_VARIABLE_INITIALIZE),
                           n_pan(CONST_VARIABLE_INITIALIZE),
                           n_tilt(CONST_VARIABLE_INITIALIZE),
                           n_contrast(CONST_VARIABLE_INITIALIZE),
                           n_brightness(CONST_VARIABLE_INITIALIZE),
                           n_saturation(CONST_VARIABLE_INITIALIZE),
                           n_sharpness(CONST_VARIABLE_INITIALIZE),
                           n_hue(CONST_VARIABLE_INITIALIZE),
                           n_whitebalancetemperature(CONST_VARIABLE_INITIALIZE),
                           n_gain(CONST_VARIABLE_INITIALIZE),
                           n_gamma(CONST_VARIABLE_INITIALIZE),
                           n_frequency(CONST_VARIABLE_INITIALIZE),
                           b_mirror(0),
                           n_exposure(CONST_VARIABLE_INITIALIZE),
                           b_autoexposure(0),
                           b_autowhitebalance(0),
                           n_bitrate(CONST_VARIABLE_INITIALIZE),
                           n_framerate(CONST_VARIABLE_INITIALIZE),
                           ngop_length(CONST_VARIABLE_INITIALIZE),
                           b_led(0),
                           b_yuvmode(0),
                           n_illumination(CONST_VARIABLE_INITIALIZE),
                           b_backlightcompensation(0),
                           n_mic_maxgain(CONST_VARIABLE_INITIALIZE),
                           n_mic_mingain(CONST_VARIABLE_INITIALIZE),
                           n_micgain(CONST_VARIABLE_INITIALIZE),
                           b_micmute(0) {}
} camera_properties_t;
