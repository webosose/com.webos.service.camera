...
DEVICE_RETURN_CODE_T VirtualDeviceManager::captureImage(int devhandle, int ncount, FORMAT sformat)
{
...
DEVICE_RETURN_CODE_T VirtualDeviceManager::startCapture(int devhandle, FORMAT sformat)
{
...
DEVICE_RETURN_CODE_T VirtualDeviceManager::setFormat(int devhandle, FORMAT oformat)
{
