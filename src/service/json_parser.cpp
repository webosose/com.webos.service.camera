...
void createGetPropertiesJsonString(CAMERA_PROPERTIES_T *properties,
                                   CAMERA_PROPERTIES_T *old_property, jvalue_ref &json_outobjparams)
{
    if (nullptr != old_property)
    {
        if (properties->nContrast != old_property->nContrast)
        {
            ...
            jobject_put(
                ...
                jnumber_create_i32(properties->stGetData.data[PROPERTY_CONTRAST][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_CONTRAST][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_CONTRAST][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_CONTRAST][QUERY_DEFAULT]));
        ...
        if (properties->nBrightness != old_property->nBrightness)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_BRIGHTNESS][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_BRIGHTNESS][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_BRIGHTNESS][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_BRIGHTNESS][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nAutoFocus != old_property->nAutoFocus)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOFOCUS][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOFOCUS][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOFOCUS][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOFOCUS][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nFocusAbsolute != old_property->nFocusAbsolute)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FOCUSABSOLUTE][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FOCUSABSOLUTE][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FOCUSABSOLUTE][QUERY_STEP]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_FOCUSABSOLUTE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nZoomAbsolute != old_property->nZoomAbsolute)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_ZOOMABSOLUTE][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_ZOOMABSOLUTE][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_ZOOMABSOLUTE][QUERY_STEP]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_ZOOMABSOLUTE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nPan != old_property->nPan)
        {
            ...
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_PAN][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_PAN][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_PAN][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_PAN][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nTilt != old_property->nTilt)
        {
            jvalue_ref json_propertyobj = jobject_create();
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_TILT][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_TILT][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_TILT][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_TILT][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nSaturation != old_property->nSaturation)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SATURATION][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SATURATION][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SATURATION][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SATURATION][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nSharpness != old_property->nSharpness)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SHARPNESS][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SHARPNESS][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SHARPNESS][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_SHARPNESS][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nHue != old_property->nHue)
        {
            jvalue_ref json_propertyobj = jobject_create();
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_HUE][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_HUE][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_HUE][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_HUE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nWhiteBalanceTemperature != old_property->nWhiteBalanceTemperature)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_WHITEBALANCETEMPERATURE][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_WHITEBALANCETEMPERATURE][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_WHITEBALANCETEMPERATURE][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_WHITEBALANCETEMPERATURE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nGain != old_property->nGain)
        {
            jvalue_ref json_propertyobj = jobject_create();
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAIN][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAIN][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAIN][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_GAIN][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nGamma != old_property->nGamma)
        {
            jvalue_ref json_propertyobj = jobject_create();
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAMMA][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAMMA][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(properties->stGetData.data[PROPERTY_GAMMA][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_GAMMA][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nFrequency != old_property->nFrequency)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FREQUENCY][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FREQUENCY][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FREQUENCY][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_FREQUENCY][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nExposure != old_property->nExposure)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_EXPOSURE][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_EXPOSURE][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_EXPOSURE][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_EXPOSURE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nAutoExposure != old_property->nAutoExposure)
        {
            ...
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOEXPOSURE][QUERY_MIN]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOEXPOSURE][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(properties->stGetData.data[PROPERTY_AUTOEXPOSURE][QUERY_STEP]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_AUTOEXPOSURE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nAutoWhiteBalance != old_property->nAutoWhiteBalance)
        {
            ...
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_AUTOWHITEBALANCE][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_AUTOWHITEBALANCE][QUERY_MAX]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_AUTOWHITEBALANCE][QUERY_STEP]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_AUTOWHITEBALANCE][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
        ...
        if (properties->nBacklightCompensation != old_property->nBacklightCompensation)
        {
            ...
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MIN),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_BACKLIGHTCOMPENSATION][QUERY_MIN]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_MAX),
                        jnumber_create_i32(
                            properties->stGetData.data[PROPERTY_BACKLIGHTCOMPENSATION][QUERY_MAX]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_STEP),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_BACKLIGHTCOMPENSATION][QUERY_STEP]));
            jobject_put(
                json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_DEFAULT_VALUE),
                jnumber_create_i32(
                    properties->stGetData.data[PROPERTY_BACKLIGHTCOMPENSATION][QUERY_DEFAULT]));
            jobject_put(json_propertyobj, J_CSTR_TO_JVAL(CONST_PARAM_NAME_VALUE),
...
void mappingPropertieswithConstValues(std::map<std::string, int> &gPropertyMap,
                                      CAMERA_PROPERTIES_T *properties)
{
    ...
    gPropertyMap.insert(std::make_pair(CONST_PARAM_NAME_WHITEBALANCETEMPERATURE,
                                       properties->nWhiteBalanceTemperature));
    ...
    gPropertyMap.insert(
        std::make_pair(CONST_PARAM_NAME_AUTOWHITEBALANCE, properties->nAutoWhiteBalance));
    gPropertyMap.insert(std::make_pair(CONST_PARAM_NAME_BACKLIGHT_COMPENSATION,
                                       properties->nBacklightCompensation));
    gPropertyMap.insert(std::make_pair(CONST_PARAM_NAME_ZOOM_ABSOLUTE, properties->nZoomAbsolute));
    gPropertyMap.insert(
        std::make_pair(CONST_PARAM_NAME_FOCUS_ABSOLUTE, properties->nFocusAbsolute));
