...
std::string GetSolutionInfoMethod::createObjectJsonString() const
{
  jvalue_ref json_outobj = jobject_create();
  std::string str_reply;
...
void EnableCameraSolutionMethod::getObject(const char *input, const char *schemapath)
{
  jvalue_ref j_obj;
  int retval = deSerialize(input, schemapath, j_obj);
...
std::string EnableCameraSolutionMethod::createObjectJsonString() const
{
  jvalue_ref json_outobj = jobject_create();
  std::string str_reply;
...
void DisableCameraSolutionMethod::getObject(const char *input, const char *schemapath)
{
  jvalue_ref j_obj;
  int retval = deSerialize(input, schemapath, j_obj);
...
std::string DisableCameraSolutionMethod::createObjectJsonString() const
{
  jvalue_ref json_outobj = jobject_create();
  std::string str_reply;
