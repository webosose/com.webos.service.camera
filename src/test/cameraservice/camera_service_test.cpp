...
testcase:
  ...
  std::string open =
      "luna-send -n 1 -f luna://com.webos.service.camera2/open '{\"id\": \"";
  std::string close = "luna-send -n 1 -f luna://com.webos.service.camera2/close '{\"handle\":";
  std::string getproperties =
      "luna-send -n 1 -f luna://com.webos.service.camera2/getProperties '{\"handle\":";
  std::string setproperties =
      "luna-send -n 1 -f luna://com.webos.service.camera2/setProperties '{\"handle\":";
  std::string setformat =
      "luna-send -n 1 -f luna://com.webos.service.camera2/setFormat '{\"handle\":";
  std::string startpreview =
      "luna-send -n 1 -f luna://com.webos.service.camera2/startPreview '{\"handle\":";
  std::string stoppreview =
      "luna-send -n 1 -f luna://com.webos.service.camera2/stopPreview '{\"handle\":";
  std::string startcapture =
      "luna-send -n 1 -f luna://com.webos.service.camera2/startCapture '{\"handle\":";
  std::string stopcapture =
      "luna-send -n 1 -f luna://com.webos.service.camera2/stopCapture '{\"handle\":";
