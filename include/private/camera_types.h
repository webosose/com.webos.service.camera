...
typedef enum
{
    ...
    DEVICE_ERROR_DEVICE_IS_ALREADY_STOPPED = 10,
    ...
    DEVICE_ERROR_APP_PERMISSION = 50,
    DEVICE_ERROR_FAIL_TO_REGISTER_SIGNAL,
    DEVICE_ERROR_CLIENT_PID_IS_MISSING,
    DEVICE_ERROR_SUBSCIRPTION_FAIL_DEVICE_DISCONNETED = 100,
    DEVICE_ERROR_DEVICE_IS_BUSY,
    DEVICE_ERROR_SERVICE_IS_NOT_READY,
...
struct CAMERA_FORMAT
{
    ...
    int nFps{0};
    camera_format_t eFormat{CAMERA_FORMAT_UNDEFINED};
